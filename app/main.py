...
def top_3_playlist():
    ...
    playlist_data = {
        "name" : f'TOP 3 Songs of {USERNAME} [{TIME_RANGE}]',
        "description" : f'The most listened songs on {TIME_RANGE}, generated by Spotify-api-resume @fungirox',
        "public" : False
    }

    id = create_playlist(headers=headers,USER_ID=USER_ID,DATA=playlist_data)
